...
<div class="container-lg">
    <form action="/addAuthor" method="POST" class="w-75">
        @csrf
...
<div class="container-lg">
    <table class="table w-75">
        ...
        <tr>
            <td>{{$author->name}}</td>
            <td>
                <button class="btn btn-outline-info" data-toggle="modal" data-target="#editAuthor" data-author="{{$author->name}}" data-authorid="{{$author->id}}">Editer</button>
            </td>
            <td>
                <button class="btn btn-outline-danger" data-toggle="modal" data-target="#deleteAuthor" data-author="{{$author->name}}" data-authorid="{{$author->id}}">X</button>
            </td>
        </tr>
        @endforeach    
    </table>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <form action="/suppAuthor" method="post">
                    @csrf
...
<div class="modal" id="editAuthor" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenteredLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/updateAuthor" method="post" class="d-flex flex-column py-3">@csrf
